...
for i in ls:
    ...
    print("({} - {}) ^ 2 =".format(i, sum_ls/totol_elem), res)
    n_ls.append(res)
...
print("Total des sommes des carres des ecart :", total_sum_pow)
print()
...
print("Variance : 1 / {} * {} = {}".format(totol_elem,total_sum_pow,variance))
print()
